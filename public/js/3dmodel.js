...
function initModel() {
  ...
  loader.load(
    ...
    function (gltf) {
      //function(gltf) is a callback function that is called when the model is loaded.
      ...
      model.traverse((child) => {
        //loops through all parts of the model to adjust materials (e.g., glass parts).
        if (child.isMesh) {
          //checks if the child is a mesh (i.e., a 3D object with a material).
  ...
  // Render loop
  function animate() {
    //continously updates/renders the scene and camera.
